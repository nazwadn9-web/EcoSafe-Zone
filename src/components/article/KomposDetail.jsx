  ...
  return (
    <>
      <div className="space-y-6 sm:space-y-8">
        ...
        {/* Hero Section */}
        <div
          className="relative bg-gradient-to-br from-green-600 to-emerald-700
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-5 sm:gap-7">
            <div className="flex-1 text-center md:text-left">
              <div
                className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 backdrop-blur-sm rounded-full
            ...
            <div className="flex-1 grid grid-cols-2 gap-2 sm:gap-3">
              {[
                ...
                >
                  <s.icon
                    className={`text-xl sm:text-2xl mx-auto mb-1 ${s.color}`}
                  />
...
const ManfaatTab = () => (
  ...
  >
    {[
      ...
      {
        icon: FaBug,
        title: "Aktivitas Mikroorganisme",
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          <div
            className={`w-10 h-10 sm:w-11 sm:h-11 ${item.iconBg} rounded-xl flex items-center justify-center`}
          >
    ...
    {[
      {
        step: 1,
        title: "Siapkan Wadah",
        desc: "Siapkan wadah atau lubang di tanah dengan ukuran yang sesuai",
        icon: FaBoxOpen,
      },
      {
        step: 2,
        title: "Masukkan Bahan",
        desc: "Masukkan sampah organik bergantian dengan tanah",
        icon: FaLeaf,
      },
      {
        step: 3,
        title: "Siram Air",
        desc: "Siram dengan air secukupnya agar tetap lembab",
        icon: FaTint,
      },
      {
        step: 4,
        title: "Aduk Rutin",
        desc: "Aduk setiap 1 minggu sekali untuk menjaga aerasi",
        icon: FaRecycle,
      },
      {
        step: 5,
        title: "Tunggu Matang",
        desc: "Tunggu 1–2 bulan hingga kompos siap digunakan",
        icon: FaClock,
      },
    ].map((step) => (
      <div
        key={step.step}
        className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl shadow-sm border border-gray-100"
      >
...
const TipsTab = () => (
  ...
  >
    {[
      ...
      <div
        key={i}
        className="bg-gradient-to-br from-yellow-50 to-orange-50 p-3 sm:p-4 rounded-xl border border-yellow-200"
      >
    ...
    <div className="grid grid-cols-4 gap-2 mb-4">
      {[
        ...
        <div key={i} className="text-center">
          <div
            className={`w-10 h-10 sm:w-12 sm:h-12 ${stage.color} rounded-full flex items-center justify-center mx-auto mb-1.5 shadow-sm`}
          >
            <GiGrowth className="text-white text-lg sm:text-xl" />
          </div>
          <div className="text-[9px] sm:text-[10px] font-semibold text-gray-600">
            {stage.week}
          </div>
